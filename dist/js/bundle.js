...
var calcWinnings = function calcWinnings() {
  ...
  $.ajax(settings).done(function (response) {
    ...
    var fifteenUSD = (1.98 * 0.15 * currentUSD).toFixed(2);
    var fortyFiveUSD = (1.98 * 0.45 * currentUSD).toFixed(2);
